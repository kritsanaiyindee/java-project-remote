...
public class NetworkScreenClient extends JFrame {
	...
	private String myFont = "sssss";
	private URL exitURL= getClass().getClassLoader().getResource("resources/exit.png");
	private ImageIcon exitIcon= new ImageIcon(exitURL);
	private URL minimizeURL =getClass().getClassLoader().getResource("resources/minimize.png"); 
